...
public class Reports 
{
	...
	public static void startReport()
	{
		try
		{
			sparkReporter= new ExtentSparkReporter(System.getProperty("user.dir")+"/BestBuyWebAutomationReport.html");
			sparkReporter.config().setDocumentTitle("BestBuyProject Web Automation Report");
			sparkReporter.config().setReportName("BestBuyProject Web Automation");
